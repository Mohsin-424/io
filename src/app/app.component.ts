...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.titleService.setTitle("Muhammad Mohsin | AI Enginner | Computer Vision Research Engineer | Embedded Software Engineer");
    this.metaService.addTags([
      { name: 'keywords', content: 'Full Stack AI Engineer , MEAN Stack Developer  ,Embedded Software Engineer' },
